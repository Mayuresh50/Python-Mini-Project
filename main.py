...
lf_bg = 'LightSkyBlue'  # Left Frame Bg
rtf_bg = 'DeepSkyBlue'  # Right Top Frame Bg
rbf_bg = 'DodgerBlue'  # Right Bottom Frame BG
btn_hlb_bg = 'SteelBlue'  # BG for Head Labels and Buttons

lbl_font = ('Cambria', 13)  # Font for all labels
entry_font = ('Times New Roman', 12)  # Font for all Entry widgets
btn_font = ('Gill Sans MT', 13)

#GUI Window 
root = Tk()
root.title('Online Library Management System')
root.geometry('1250x530')
root.resizable(0, 0)

Label(root, text='ONLINE LIBRARY MANAGEMENT SYSTEM', font=("Noto Sans CJK TC", 15, 'bold'), bg=btn_hlb_bg, fg='White').pack(side=TOP, fill=X)
...
tree.heading('Issuer Card ID', text='Issuer Card ID and Time', anchor=CENTER)
...
tree.column('#5', width=132, stretch=YES)

tree.place(y=30, x=0, relheight=1.0, relwidth=1)
